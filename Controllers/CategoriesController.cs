...
namespace StockMgmt.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("category")] Category category)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!CategoryExists(category.category))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.Category.Any(e => e.category == id);
        }
    }
}
